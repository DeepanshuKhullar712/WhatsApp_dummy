...
import 'package:whatsapp_dummy/modals/chatModel.dart';

class StoryScreenUI extends StatefulWidget {
  const StoryScreenUI({Key key}) : super(key: key);

  @override
  _StoryScreenUIState createState() => _StoryScreenUIState();
}
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      SizedBox(height:5),
                      Text("Add Status",style: TextStyle(color: Colors.black,fontWeight: FontWeight.w500),)
                    ],
                  ),
                ),
                Row(
